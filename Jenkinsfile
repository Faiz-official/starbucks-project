pipeline{
    ...
    stages {
            ...
            steps{
                script{
                   withDockerRegistry(credentialsId: 'docker', toolName: 'docker'){   
                       ...
                       sh "docker tag starbucks mydockerhub/starbucks12:latest "
        ...
        stage('App Deploy to Docker container'){
            steps{
                sh 'docker run -d --name starbucks -p 3000:3000 mydockerhub12/starbucks:latest'
            }
        }
    ...
    always {
        script {
            ...
            emailext (
                ...
                from: 'faizshaikh.fs574@gmail.com',
                replyTo: 'faizshaikh.fs574@gmail.com',
                mimeType: 'text/html',
